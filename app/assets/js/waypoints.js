...
(function($, wp, wps, window, undefined){
	...
	*/
	Context = function(context) {
		...
		$(context).bind('scroll.waypoints', $.proxy(function() {
			...
			if (!this.didResize) {
				// this.didResize = true;
				// window.setTimeout($.proxy(function() {                I commented this out because it would reset the position of the controls on resize.
				// 	$[wps]('refresh');
	...
	*/
	$[wps].settings = {
		resizeThrottle: 200,
		scrollThrottle: 100      //default was 100, I made it 20 to prevent bugs when scrolling too fast. Change back if performance issues.
	};
